 ...
 */
export const FIXED_TIME_SLOTS = generateTimeSlots();
 ...
 * 
 * @param {number} blockIndex - Index of time block (0-5)
 * @returns {Array} Array of slot objects for that block
 */
export const getSlotsForBlock = (blockIndex) => {
